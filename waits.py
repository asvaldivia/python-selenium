...
class ExplicitWaitTests(unittest.TestCase):
    ...
    def test_account_link(self):
        ...
        account = WebDriverWait(self.driver, 10).until(
            expected_conditions.visibility_of_element_located((By.LINK_TEXT, 'ACCOUNT')))
        account.click()
    ...
    def test_create_new_customer(self):
        ...
        my_account = WebDriverWait(self.driver, 10).until(
            expected_conditions.visibility_of_element_located((By.LINK_TEXT, 'My Account')))
        my_account.click()

        create_account_button = WebDriverWait(self.driver, 20).until(
            expected_conditions.element_to_be_clickable((By.LINK_TEXT, 'CREATE AN ACCOUNT')))
